export default {
  ...
  FeaturedCollectionList: {
    heading: 'DApp-Sammlungen'
  },
  FeaturedDappList: {
    heading: 'Ausgewählte DApps',
  ...
  help: {
    volumeUsd:
      'Transaktionsvolumen der DApp Verträge. Die Wechselkurse stammen von CryptoCompare.com',
    volumePerNetwork:
      'Transaktionsvolumen der DApp Verträge. Da Plattformen unterschiedliche Währungen verwenden, sollten Werte nicht direkt verglichen werden. Die Wechselkurse stammen von CryptoCompare.com'
  },
  GlobalSearch: {
    dapps: 'DApps',
  ...
  // TODO submitQuestionPlaceholder: 'Enter an amount (USD)',
