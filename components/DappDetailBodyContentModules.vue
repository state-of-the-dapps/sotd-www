      ...
      <div
        ...
        <div
          ...
          <DappDetailBodyContentModulesStats
            ...
            type="numbers"/>
          <DappDetailBodyContentModulesStats
            v-if="dapp.stats.moonriver_value_30d"
            :daily="dapp.stats.moonriver_value_1d"
            :monthly="dapp.stats.moonriver_value_30d"
            :sparkline="dapp.sparklines.moonriver_value"
            :quarterly="dapp.stats.moonriver_value_90d"
            :weekly="dapp.stats.moonriver_value_7d"
            :title="$t(namespace('volume'), {token: 'MOVR'})"
            type="numbers"/>
          <DappDetailBodyContentModulesStats
            v-if="dapp.stats.meter_value_30d"
            :daily="dapp.stats.meter_value_1d"
            :monthly="dapp.stats.meter_value_30d"
            :sparkline="dapp.sparklines.meter_value"
            :quarterly="dapp.stats.meter_value_90d"
            :weekly="dapp.stats.meter_value_7d"
            :title="$t(namespace('volume'), {token: 'MTR'})"
            type="numbers"/>
        </div>
      </div>
      <div
