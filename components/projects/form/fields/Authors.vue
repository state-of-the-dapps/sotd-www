<template>
  <div class="item" :class="errors && errors.length > 0 ? '--has-errors' : ''">
    <input class="text-input" :class="authors.length > 0 ? '--is-filled' : ''" type="text" maxlength="100" v-model="author" @input="validate">
    ...
    methods: {
      validate () {
        ...
        validationTimer = setTimeout(() => {
          this.authors.length > 25 ? errors.data.push(`Authors can't be longer than 100 characters`) : ''
