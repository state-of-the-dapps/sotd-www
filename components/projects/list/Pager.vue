<template>
  <section class="section">
    <div class="container">
      ...
      <p v-if="itemCount >= totalCount && !isLoading" class="message">No {{ itemCount > 0 ? 'more' : '' }} ÐApps here. You can always <nuxt-link @click.native="$mixpanel.track('Projects - New project')" :to="{ name: 'projects-new' }" class="link">submit one!</nuxt-link></p>
