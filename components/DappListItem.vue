<template>
  <li class="component-DappListItem">
    <ul class="columns">
      ...
      <li class="column -dau">
        {{ dapp.stats.dau.toLocaleString(undefined, {maximumFractionDigits: 0}) }}
      </li>
      <li class="column -mau">
        {{ dapp.stats.mau.toLocaleString(undefined, {maximumFractionDigits: 0}) }}
      </li>
      <li class="column -vol_7d">
        {{ dapp.stats.value_7d.toLocaleString(undefined, {maximumFractionDigits: 0}) }} ETH
      </li>
    </ul>
  </li>
</template>
